...
import static utilz.HelpMethods.IsProjectileHittingLvl;
...
public class ObjectManager {
        ...
        for(Projectile p:projectiles)
            if(p.isActive()) {
                ...
                if(p.getHitbox().intersects(player.getHitbox())) {
                    ...
                    p.setActive(false);
                }else if(IsProjectileHittingLvl(p,lvlData))
                    p.setActive(false);
            }
    }
    ...
    private void drawCannons(Graphics g, int xLvlOffset) {
        for(Cannon c:cannons) {
            ...
            g.drawImage(cannonImgs[c.getAniIndex()], x, (int)(c.getHitbox().y), w, CANNON_HEIGHT, null);
        }
    }
